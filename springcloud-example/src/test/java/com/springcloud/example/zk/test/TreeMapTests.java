...
public class TreeMapTests {
    public static void main(String[] agrs) {
        ...
        System.out.println("初始化后,TreeMap元素个数为：" + treeMap.size()); // 0
        ...
        System.out.println("添加元素后,TreeMap元素个数为：" + treeMap.size()); // 10
        ...
        for (Map.Entry<String, Integer> entry : entrySet) {
            ...
            // a am developer hello i is jiaboyan my name world
